...
type OnboardingCollaborateScreenProps = ConnectedProps<typeof reduxConnector> & OnboardingProps;

type OnboardingCollaborateFormState = {
    birthDate: Date | null;
    gender: Gender | null;
    nationality: CountryCode | null;
};

class OnboardingCollaborateScreen extends React.Component<OnboardingCollaborateScreenProps> {
    submit(values: OnboardingCollaborateFormState) {
    ...
    render(): JSX.Element {
        ...
        return (
            <Formik
                initialValues={onboardingState as OnboardingCollaborateFormState}
                validationSchema={VALIDATION_SCHEMA}
                validateOnChange={true}
                validateOnBlur={false}
                onSubmit={(values: OnboardingCollaborateFormState) => this.submit(values)}
            >
                {(formikProps: FormikProps<OnboardingCollaborateFormState>) => {
...
export default reduxConnector(OnboardingCollaborateScreen);
